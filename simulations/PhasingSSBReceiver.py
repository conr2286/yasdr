...
# Title: Phasing SSB Receiver
# Author: KQ7B
# Description: Simulation of a phasing (no AGC, noise reduction, notch, etc) SSB receiver using Weaver method with complex/float data.  The data file source is from https://www.csun.edu/~skatz/katzpage/sdr_project/sdr/ssb_lsb_256k_complex2.dat.zip
...
class PhasingSSBReceiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Phasing SSB Receiver", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Phasing SSB Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PhasingSSBReceiver")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(audio_rate, analog.GR_COS_WAVE, 3000, 1, 0, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_complex_to_float_1, 0))
        ...
        self.connect((self.blocks_complex_to_float_1, 1), (self.blocks_multiply_const_vxx_1, 0))
        ...
        self.connect((self.blocks_complex_to_real_1, 0), (self.blocks_add_xx_0, 0))
...
def main(top_block_cls=PhasingSSBReceiver, options=None):
