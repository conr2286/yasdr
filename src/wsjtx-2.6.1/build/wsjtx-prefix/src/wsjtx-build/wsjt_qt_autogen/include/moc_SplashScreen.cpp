...
#include <memory>
#include "../../../wsjtx/widgets/SplashScreen.hpp"
...
QT_MOC_LITERAL(1, 13, 8), // "disabled"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "SplashScreen\0disabled\0"
};
...
void SplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SplashScreen::disabled)) {
                *result = 0;
                return;
            }
        }
