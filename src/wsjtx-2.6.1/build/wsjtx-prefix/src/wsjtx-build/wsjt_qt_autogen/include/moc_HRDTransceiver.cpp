...
#include <memory>
#include "../../../wsjtx/Transceiver/HRDTransceiver.hpp"
...
struct qt_meta_stringdata_HRDTransceiver_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HRDTransceiver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HRDTransceiver_t qt_meta_stringdata_HRDTransceiver = {
    {
QT_MOC_LITERAL(0, 0, 14) // "HRDTransceiver"
...
static const uint qt_meta_data_HRDTransceiver[] = {
...
QT_INIT_METAOBJECT const QMetaObject HRDTransceiver::staticMetaObject = { {
    QMetaObject::SuperData::link<PollingTransceiver::staticMetaObject>(),
    qt_meta_stringdata_HRDTransceiver.data,
    qt_meta_data_HRDTransceiver,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *HRDTransceiver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HRDTransceiver.stringdata0))
