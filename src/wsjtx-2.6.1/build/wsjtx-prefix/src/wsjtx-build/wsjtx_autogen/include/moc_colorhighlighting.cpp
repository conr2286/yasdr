...
#include <memory>
#include "../../../wsjtx/widgets/colorhighlighting.h"
...
void ColorHighlighting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ColorHighlighting *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ColorHighlighting::staticMetaObject = { {
    ...
    qt_meta_stringdata_ColorHighlighting.data,
    qt_meta_data_ColorHighlighting,
    qt_static_metacall,
    nullptr,
    nullptr
} };
